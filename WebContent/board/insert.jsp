...
<div class="wrapper row3 join_row">
    ...
    <td width=85%>
    	<input type=text name=title class="input-sm" size=55>
    </td>
    </tr>
    <tr>
    ...
    <td width=85%>
    	<input type=text name=add class="input-sm" size=55 readonly value="${add}" style="border: none">
    ...
    <td colspan="2" class="text-center">
        <button class="sendBtn">글쓰기</button>
