...
<div class="wrapper row3 join_row">
	 ...
	 <table class="table">
	   ...
	   <tr>
	   <tr>
	   	<th class="text-center danger" width=20%>상품 정보</th>
	     <td colspan="3" class="text-left">${vo.add}</td>
	   </tr>
	   <tr>
	     ...
	     <c:if test="${vo.id eq id}">
	      ...
	      <a href="../board/delete.do?no=${vo.bno}&type=0" class="btn btn-sm btn-success">삭제</a>
	      </c:if>
	      <a href="../board/qaboard.do" class="btn btn-sm btn-info">목록</a>
	     </td>
	   </tr>
