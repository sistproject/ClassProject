...
<div class="wrapper row3 join_row">
		...
		<h2 class="sectiontitle" class="text-center" style="display:block;text-align:center">글수정</h2>
		<div style="height:30px"></div>
		<div style="height:800px;">
	 <form method=post action="../board/update_ok.do?no=${vo.bno}&type=${type}" id="frm" autocomplete="off">
    <table class="table">
    <tr>
    ...
    <td width=85%>
    	<input type=text name=title class="input-sm" size=55 value="${vo.title }">
    </td>
    </tr>
    <tr>
    ...
    <td colspan="2" class="text-center">
    	<button class="sendBtn">수정</button>
