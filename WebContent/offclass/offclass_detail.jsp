					...
					<div class="course_container">
						...
						<div class="course_info d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-start">
							...
							<div class="course_info_item">
								...
								<div class="course_info_text"><a href="#">카테고리</a></div>
							</div>

							<!-- Course Info Item -->
							<div class="course_info_item">
								<div class="course_info_title">위치:</div>
								<div class="course_info_text"><a href="#">ㅇㅇ시ㅇㅇ구</a></div>
							</div>

							<!-- Course Info Item -->
							<div class="course_info_item">
								<div class="course_info_title">아티스트:</div>
								<div class="course_info_text"><a href="#">아티스트</a></div>
							</div>
...
<div class="container">
  <button type="button" class="btn btn-primary btn-lg btn-block" style="width:300px">예약하기</button>
