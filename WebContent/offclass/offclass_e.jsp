				...
				<div class="col-lg-8">
					...
					<div class="courses_container">
						<div class="row courses_row">
							...
							<!-- Course -->
							<c:forEach var="ofe" items="${ofeList}"> 
							<div class="col-lg-6 course_col">
								<div class="course">
									<div class="course_image"><img src="${ofe.cposter }" alt=""></div>
									<div class="course_body">
										<div class="course_category">${ofe.ccategory }</div>
										<h3 class="course_title"><a href="../offclass/offclass_detail.do?cno=${ofe.cno }">${ofa.etitle }</a></h3>
										<div class="course_teacher">${ofe.cartist }</div>
									</div>
									<div class="course_footer">
										<div class="course_footer_content d-flex flex-row align-items-center justify-content-start">
											<div class="course_info">
												<span>${ofe.infoaddr }</span>
											</div>
											<div class="course_info">
												<i class="fa fa-star" aria-hidden="true"></i>
												<span>${ofe.cscore }</span>
											</div>
											<div class="course_price ml-auto">${ofe.cprice }</div>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="pagination_container d-flex flex-row align-items-center justify-content-start">
									<ul class="pagination_list">
							          <c:if test="${startPage>1 }">
							           <li><a href="../offclass/offclass_e.do?page=${startPage-1 }">이전</a></li>
							          </c:if>
							          <c:forEach var="i" begin="${startPage }" end="${endPage }" step="1">
							            ...
							            <li ${type }><a href="../offclass/offclass_e.do?page=${i }">${i }</a></li>
							          </c:forEach>
							          <c:if test="${endPage<totalPage }">
							            <li><a href="../offclass/offclass_e.do?page=${endPage+1 }"> 다음</a></li>
							          </c:if>
							        </ul>
								</div>
							</div>
