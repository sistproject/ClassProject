				...
				<div class="col-lg-8">
					...
					<div class="courses_container">
						<div class="row courses_row">
							...
							<!-- Course -->
							<c:forEach var="ofb" items="${ofbList}"> 
							<div class="col-lg-6 course_col">
								<div class="course">
									<div class="course_image"><img src="${ofb.cposter }" alt=""></div>
									<div class="course_body">
										<div class="course_category">${ofb.ccategory }</div>
										<h3 class="course_title"><a href="../offclass/offclass_detail.do?cno=${ofb.cno }">${ofb.ctitle }</a></h3>
										<div class="course_teacher">${ofb.cartist }</div>
									</div>
									<div class="course_footer">
										<div class="course_footer_content d-flex flex-row align-items-center justify-content-start">
											<div class="course_info">
												<span>${ofb.infoaddr }</span>
											</div>
											<div class="course_info">
												<i class="fa fa-star" aria-hidden="true"></i>
												<span>${ofb.cscore }</span>
											</div>
											<div class="course_price ml-auto">${ofb.cprice }</div>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="pagination_container d-flex flex-row align-items-center justify-content-start">
									<ul class="pagination_list">
							          <c:if test="${startPage>1 }">
							           <li><a href="../offclass/offclass_b.do?page=${startPage-1 }">이전</a></li>
							          </c:if>
							          <c:forEach var="i" begin="${startPage }" end="${endPage }" step="1">
							            ...
							            <li ${type }><a href="../offclass/offclass_b.do?page=${i }">${i }</a></li>
							          </c:forEach>
							          <c:if test="${endPage<totalPage }">
							            <li><a href="../offclass/offclass_b.do?page=${endPage+1 }"> 다음</a></li>
							          </c:if>
							        </ul>
								</div>
							</div>
