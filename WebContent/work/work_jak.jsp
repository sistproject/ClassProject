								...
								<div class="list_number">
									<ul>
							          <c:if test="${startpage>1 }">
							           <li style="display:inline-block;"><a href="../work/work_jak.do?page=${startpage-1 }">이전</a></li>
							          </c:if>
							          <c:forEach var="i" begin="${startpage }" end="${endpage }" step="1">
							            ...
							            <li ${type }  style="display:inline-block;"><a href="../work/work_jak.do?page=${i }">${i }</a></li>
							          </c:forEach>
							          <c:if test="${endpage<totalpage }">
							            <li  style="display:inline-block;"><a href="../work/work_jak.do?page=${endpage+1 }"> 다음</a></li>
							          </c:if>
							        </ul>
								</div>
							</div>
