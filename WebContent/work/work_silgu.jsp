								...
								<div class="list_number">
									<ul>
							          ...
							          <c:forEach var="i" begin="${startpage }" end="${endpage }" step="1">
							            ...
							            <li ${type }  style="display:inline-block;"><a href="../work/work_silgu.do?page=${i }">${i }</a></li>
							          </c:forEach>
							          <c:if test="${endpage<totalpage }">
							            <li  style="display:inline-block;"><a href="../work/work_silgu.do?page=${endpage+1 }"> 다음</a></li>
							          </c:if>
							        </ul>
								</div>
							</div>
