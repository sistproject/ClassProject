								...
								<div class="list_number" style="text-align: center">
									<ul class="pagination_list">
							          <c:if test="${startPage>1 }">
							           <li style="display:inline-block;"><a href="../class/recommendclass.do?age=${startPage-1 }">이전</a></li>
							          </c:if>
							          <c:forEach var="i" begin="${startPage }" end="${endPage }" step="1">
							            ...
							            <li ${type }  style="display:inline-block;"><a href="../class/recommendclass.do?page=${i }">${i }</a></li>
							          </c:forEach>
							          <c:if test="${endPage<totalPage }">
							            <li  style="display:inline-block;"><a href="../class/recommendclass.do?page=${endPage+1 }"> 다음</a></li>
							          </c:if>
							        </ul>
								</div>
							</div>
