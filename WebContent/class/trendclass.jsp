								...
								<div class="list_number" style="text-align: center">
									<ul class="pagination_list">
							          <c:if test="${startPage>1 }">
							           <li style="display:inline-block;"><a href="../class/trendclass.do?page=${startPage-1 }">이전</a></li>
							          </c:if>
							          ...
							          <c:if test="${endPage<totalPage }">
							            <li  style="display:inline-block;"><a href="../class/trendclass.do?page=${endPage+1 }"> 다음</a></li>
							          </c:if>
							        </ul>
								</div>
							</div>
